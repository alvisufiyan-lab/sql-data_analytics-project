...
BEGIN
    ...
    INSERT INTO dw_silver.crm_products (
        prd_id, prd_key, prd_key2, cat_key, prd_nm, prd_cost,
        prd_line, prd_start_dt, prd_end_dt, dw_create_date
    )
    SELECT
        prd_id,
        prd_key,
        REPLACE(SUBSTRING(prd_key, 1, 5), "-", "_"   )                    AS prd_key2,
        SUBSTRING(prd_key, 7, LENGTH(prd_key)-6)                          AS cat_id,
